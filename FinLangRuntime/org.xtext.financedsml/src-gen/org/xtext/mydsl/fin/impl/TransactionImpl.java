 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.mydsl.fin.impl.TransactionImpl#getPortfolio <em>Portfolio</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransactionImpl extends ElementImpl implements Transaction
{
    ...
    if (portfolio != null && portfolio.eIsProxy())
    {
      ...
      if (portfolio != oldPortfolio)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, FinPackage.TRANSACTION__PORTFOLIO, oldPortfolio, portfolio));
      }
    }
    return portfolio;
  }
  ...
  public void setPortfolio(Portfolio newPortfolio)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FinPackage.TRANSACTION__PORTFOLIO, oldPortfolio, portfolio));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FinPackage.TRANSACTION__PORTFOLIO:
